...
```{r}
ggplot(sdr_data, aes(x= goal_2_score, y= goal_6_score, color = goal_6_score)) + geom_point()
...
In this scatterplot I can tell that the scores average from 60-75 and not much in the 20-45. 
